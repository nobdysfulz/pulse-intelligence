...
export default function ClerkSupabaseSync() {
  ...
  useEffect(() => {
    ...
    console.log('  - Match:', process.env.NEXT_PUBLIC_SUPABASE_URL === 'https://gzdzmqpkbgvkuulykjml.supabase.co');
  }, []);
      ...
      const syncUser = async () => {
        ...
        try {
          ...
          const response = await fetch(
            `${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/clerkSyncProfile`,
            {
              method: 'POST',
              headers: {
