  ...
  return (
    <div className="absolute bottom-20 left-4 w-60 bg-white rounded-lg shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-bottom-2 duration-300" style={{ color: '#565d6d' }}>
      ...
      <div className="p-2 space-y-1">
        <Link to={'/settings'} onClick={onClose} className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-slate-100 text-sm font-medium">
        ...
        <Link to={'/settings?tab=referrals'} onClick={onClose} className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-slate-100 text-sm font-medium">
          <Target className="w-4 h-4" /> Share & Earn
        </Link>
        <Link to={'/plans'} onClick={onClose} className="flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-slate-100 text-sm font-medium">
