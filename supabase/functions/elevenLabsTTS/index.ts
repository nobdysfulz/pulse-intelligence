...
serve(async (req) => {
  ...
  try {
    ...
    // Map persona to voice ID (using default voices from ElevenLabs)
    const voiceMap: Record<string, string> = {
      'first_time_buyer': '9BWtsMINqrJLrRacOk9x', // Aria
      'luxury_buyer': 'EXAVITQu4vr4xnSDxMaL', // Sarah
      'investor': 'IKne3meq5aSn9XLyUdCD', // Charlie
      'seller': 'FGY2WhTYpPnrIDTdsKH5', // Laura
      'default': 'EXAVITQu4vr4xnSDxMaL' // Sarah
    };

    const voiceId = voiceMap[persona] || voiceMap.default;
