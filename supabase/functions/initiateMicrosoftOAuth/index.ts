...
serve(async (req) => {
  ...
  try {
    ...
    const redirectUri = 'https://pulse.pwru.app/auth/callback/microsoft';
    ...
    const scope = 'offline_access User.Read Mail.Send Mail.ReadWrite Calendars.ReadWrite';
    ...
    console.error('Error in initiateMicrosoftOAuth:', error);
